                ...
                LazyColumn(
                    ...
                    item {
                        Button(onClick = {
                            ...
                            startActivity(Intent(this@MenuActivity, SharePreferencesActivity::class.java), options.toBundle())
                        }) {
                            Text(text = "SharePreferencesActivity (Clip Reveal)")
                        }
                    }
                    ...
                    item {
                        Button(onClick = {
                            ...
                            startActivity(Intent(this@MenuActivity, GalleryPermissionActivity::class.java), options.toBundle())
                        }) {
                            Text(text = "GalleryPermissionActivity (Scene Transition)")
                        }
                    }
